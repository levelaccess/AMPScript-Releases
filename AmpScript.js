...
function dataReading() {
  const reading = [
    ...
    },
    {
      ...
      text: "Date pickers",
      value:
        "For more information about creating accessible custom date pickers, please see the WhatSock website: https://whatsock.com/Templates/Datepickers/index.htm",
    },
    {
      id: "reading-dialogs",
      text: "Dialogs",
    ...
    {
      id: "reading-drag-and-drop",
      text: "Drag and drop",
      value:
        "For more information about creating accessible drag-and-drop controls, please see the WhatSock website: https://whatsock.com/Templates/Drag/index.htm",
    },
    {
      id: "reading-errors",
      text: "Errors",
    ...
    },
    {
      ...
      text: "Live regions",
      value:
        "For more information about creating ARIA live regions, please see the WhatSock website: https://whatsock.com/training/#hd24",
    },
    {
    ...
    },
    {
      ...
      text: "Tooltips",
      value:
        "For more information about creating accessible tooltips, please see the WhatSock website: https://whatsock.com/Templates/Tooltips/index.htm",
    },
    {
...
function dataSuccessCriteria(){
  ...
  var sc = [
     ...
     {"id": "sc_1-1-1",  "version": "2.0", "level": "A",   "text": "SC 1.1.1 Non-text Content"},
     {"id": "sc_1-2-1",  "version": "2.0", "level": "A",   "text": "SC 1.2.1 Audio-only and Video-only (Pre-recorded)"},
     {"id": "sc_1-2-2",  "version": "2.0", "level": "A",   "text": "SC 1.2.2 Captions (Pre-recorded)"},
     {"id": "sc_1-2-3",  "version": "2.0", "level": "A",   "text": "SC 1.2.3 Audio Description or Media Alternative (Pre-recorded)"},
     {"id": "sc_1-2-4",  "version": "2.0", "level": "AA",  "text": "SC 1.2.4 Captions (Live)"},
     {"id": "sc_1-2-5",  "version": "2.0", "level": "AA",  "text": "SC 1.2.5 Audio Description (Pre-recorded)"},
     ...
     {"id": "sc_1-3-1",  "version": "2.0", "level": "A",   "text": "SC 1.3.1 Info and Relationships"},
     {"id": "sc_1-3-2",  "version": "2.0", "level": "A",   "text": "SC 1.3.2 Meaningful Sequence"},
     {"id": "sc_1-3-3",  "version": "2.0", "level": "A",   "text": "SC 1.3.3 Sensory Characteristics"},
     {"id": "sc_1-3-4",  "version": "2.1", "level": "AA",  "text": "SC 1.3.4 Orientation"},
     {"id": "sc_1-3-5",  "version": "2.1", "level": "AA",  "text": "SC 1.3.5 Identify Input Purpose"},
     // {"id": "sc_1-3-6",  "version": "2.1", "level": "AAA", "text": "SC 1.3.6 Identify Purpose"},
     {"id": "sc_1-4-1",  "version": "2.0", "level": "A",   "text": "SC 1.4.1 Use of Colour"},
     {"id": "sc_1-4-2",  "version": "2.0", "level": "A",   "text": "SC 1.4.2 Audio Control"},
     {"id": "sc_1-4-3",  "version": "2.0", "level": "AA",  "text": "SC 1.4.3 Contrast (Minimum)"},
     {"id": "sc_1-4-4",  "version": "2.0", "level": "AA",  "text": "SC 1.4.4 Resize Text"},
     {"id": "sc_1-4-5",  "version": "2.0", "level": "AA",  "text": "SC 1.4.5 Images of Text"},
     ...
     {"id": "sc_1-4-11", "version": "2.1", "level": "AA",  "text": "SC 1.4.11 Non-Text Contrast"},
     {"id": "sc_1-4-12", "version": "2.1", "level": "AA",  "text": "SC 1.4.12 Text Spacing"},
     {"id": "sc_1-4-13", "version": "2.1", "level": "AA",  "text": "SC 1.4.13 Content on Hover or Focus"},
     {"id": "sc_2-1-1",  "version": "2.0", "level": "A",   "text": "SC 2.1.1 Keyboard"},
     {"id": "sc_2-1-2",  "version": "2.0", "level": "A",   "text": "SC 2.1.2 No Keyboard Trap"},
     // {"id": "sc_2-1-3",  "version": "2.0", "level": "AAA", "text": "SC 2.1.3 Keyboard (No Exception)"},
     {"id": "sc_2-1-4",  "version": "2.1", "level": "A",   "text": "SC 2.1.4 Character Key Shortcuts"},
     {"id": "sc_2-2-1",  "version": "2.0", "level": "A",   "text": "SC 2.2.1 Timing Adjustable"},
     {"id": "sc_2-2-2",  "version": "2.0", "level": "A",   "text": "SC 2.2.2 Pause, Stop, Hide"},
     ...
     {"id": "sc_2-3-1",  "version": "2.0", "level": "A",   "text": "SC 2.3.1 Three Flashes or Below"},
     ...
     {"id": "sc_2-4-1",  "version": "2.0", "level": "A",   "text": "SC 2.4.1 Bypass Blocks"},
     // {"id": "sc_2-4-10", "version": "2.0", "level": "AAA", "text": "SC 2.4.10 Section Headings"},
     {"id": "sc_2-4-2",  "version": "2.0", "level": "A",   "text": "SC 2.4.2 Page Titled"},
     {"id": "sc_2-4-3",  "version": "2.0", "level": "A",   "text": "SC 2.4.3 Focus Order"},
     {"id": "sc_2-4-4",  "version": "2.0", "level": "A",   "text": "SC 2.4.4 Link Purpose (In Context)"},
     {"id": "sc_2-4-5",  "version": "2.0", "level": "AA",  "text": "SC 2.4.5 Multiple Ways"},
     {"id": "sc_2-4-6",  "version": "2.0", "level": "AA",  "text": "SC 2.4.6 Headings and Labels"},
     {"id": "sc_2-4-7",  "version": "2.0", "level": "AA",  "text": "SC 2.4.7 Focus Visible"},
     ...
     {"id": "sc_2-5-1",  "version": "2.1", "level": "A",   "text": "SC 2.5.1 Pointer Gestures"},
     {"id": "sc_2-5-2",  "version": "2.1", "level": "A",   "text": "SC 2.5.2 Pointer Cancellation"},
     {"id": "sc_2-5-3",  "version": "2.1", "level": "A",   "text": "SC 2.5.3 Label in Name"},
     {"id": "sc_2-5-4",  "version": "2.1", "level": "A",   "text": "SC 2.5.4 Motion Actuation"},
     ...
     {"id": "sc_3-1-1",  "version": "2.0", "level": "A",   "text": "SC 3.1.1 Language of Page"},
     {"id": "sc_3-1-2",  "version": "2.0", "level": "AA",  "text": "SC 3.1.2 Language of Parts"},
     ...
     {"id": "sc_3-2-3",  "version": "2.0", "level": "AA",  "text": "SC 3.2.3 Consistent Navigation"},
     {"id": "sc_3-2-4",  "version": "2.0", "level": "AA",  "text": "SC 3.2.4 Consistent Identification"},
     // {"id": "sc_3-2-5",  "version": "2.0", "level": "AAA", "text": "SC 3.2.5 Change on Request"},
     {"id": "sc_3-3-1",  "version": "2.0", "level": "A",   "text": "SC 3.3.1 Error Identification"},
     {"id": "sc_3-3-2",  "version": "2.0", "level": "A",   "text": "SC 3.3.2 Labels or Instructions"},
     {"id": "sc_3-3-3",  "version": "2.0", "level": "AA",  "text": "SC 3.3.3 Error Suggestion"},
     {"id": "sc_3-3-4",  "version": "2.0", "level": "AA",  "text": "SC 3.3.4 Error Prevention (Legal, Financial, Data)"},
     ...
     {"id": "sc_4-1-2",  "version": "2.0", "level": "A",   "text": "SC 4.1.2 Name, Role, Value"},
     {"id": "sc_4-1-3",  "version": "2.1", "level": "AA",  "text": "SC 4.1.3 Status Messages"}
   ]; 
         ...
         "children": [
            {
               "id":             "response-aria",
               "text":           "General",
               "impact":         "When ARIA attributes (state, roles, and properties) are inappropriately used or not used correctly, assistive technology may not correctly function as expected. Role and properties are covenants between assistive technology and the application and must be accurate for the intended purpose. Valid markup should always be used.",
               "recommendation": "Developers must use valid markup and follow the rules of the ARIA specification as well as correctly setting ARIA properties, including roles based on the intended purpose.",
               "reading":        "More information about using ARIA roles can be found on the Level Access Website:\n\nhttps://www.levelaccess.com/how-not-to-misuse-aria-states-properties-and-roles/",
               "keepElement":    true,
               "keepAttribute":  true
            },
            {
               ...
               "text":           "Implicit Role",
               "issue":          "There are elements on the page that have assigned roles but already have implicit ARIA roles. These are redundant and should be removed. Structural implicit roles include (but are not limited to[ELEMENT/role]):\n- MAIN = main\n- HEADER = banner \n- FOOTER = contentinfo\n- ASIDE = complementary\n- FORM = form\n- NAV = navigation\n\nInline implicit roles include A = link, BUTTON = button, and many others.",
               "impact":         "When ARIA attributes (state, roles, and properties) are inappropriately used, assistive technology may not correctly function as expected. Role and properties are covenants between assistive technology and the application and must be accurate for the intended purpose.",
               "recommendation": "Remove the redundant role from all of the elements.\n\nMore information can be found about implicit ARIA roles here:\nhttps://a11yproject.com/posts/aria-landmark-roles/",
               "reading":        "More information can be found about implicit ARIA roles here:\nhttps://a11yproject.com/posts/aria-landmark-roles/",
               "keepElement":    true,
               "keepAttribute":  true
            },
            {
      ...
      },
      {
         ...
         "children": [
            ...
            },
            {
               ...
               "text":           "Label",
               "impact":         "When form fields do not explicitly include a label, assistive technologies may incorrectly render the label or provide no label at all to users. When labels are not present or are incorrect, users of assistive technologies may not be able to complete a form.",
               "recommendation": "While there are several techniques for making an accessible label for the form fields, the easiest and most reliable is to have a valid HTML LABEL element that is explicitly associated with the input using the FOR/ID attributes.",
               "keepElement":    true,
               "keepAttribute":  true
            }
         ]
      ...
      },
      {
         ...
         "children": [
            ...
            },
            {
               ...
               "text":           "Obsolete",
               "issue":          "Throughout the pages, there are depreciated HTML elements and attributes. Elements such as CENTER and FONT, and attributes such as NAME, ALIGN, VALIGN, CELLPADDING, CELLSPACING, WIDTH, HEIGHT, and BORDER should be removed from the pages.",
               "impact":         "Screen readers and other assistive technology may not support deprecated HTML. Also, many of the deprecated attributes are related to styling the content on the page, which to increase compatibility with the most significant number of devices, should be moved to CSS.",
               "recommendation": "Replace all depreciated/obsolete HTML elements with elements in the current standard. The best way to know that a document does not have any depreciated elements is to run the document through the W3C's HTML validator and then review the errors/warnings.\n\nhttps://validator.w3.org/",
               "reading":        "For more information on depreciated items, please refer to the W3C specification for HTML5:\n\nDepreciated Elements\nhttps://www.w3.org/TR/html5-diff/#obsolete-elements\n\nDepreciated Attributes\nhttps://www.w3.org/TR/html5-diff/#obsolete-attributes",
               "keepElement":    true
            }
         ]
      },
         ...
         "children": [
            {
               ...
               "impact":         "Dialogs must provide a mechanism for users to close the dialog using the keyboard. This includes the ability to navigate to the close link via the keyboard such as by tabbing or shift+tabbing. The user must also be able to activate the link or button via the keyboard.",
               "recommendation": "Developers should ensure that the element used to close the dialog is reachable via the keyboard. Typically this would be through use of the tab or shift+tab key. Additionally, access keys such as the letter \"c\" with a modifier can be used to close the link. In general the access key should be in addition to ensuring the close method is in the tab order. Developers should ensure that the close link/button can be activated via the keyboard via the ENTER key. It is recommended but not required to provide an additional close link at the bottom of the dialog to allow users of assistive technology to more effectively close the dialog. This additional redundant close link can be on or off-screen and should be in the tab order.",
               "keepElement":    true,
               "keepAttribute":  true
            },
            {
         ...
         "children": [
            {
               ...
               "text":             "Color Only",
               "impact":           "Color must not be the sole method of indicating a link within non-linked text.",
               "recommendation":   "The link must possess other visual attributes upon keyboard focus such as becoming underlined. Additionally, the color of the link text and non-linked text must meet color contrast requirements for the WCAG conformance level sought.",
               "compliantExample": "a:visited, a:hover, a:active { color: #ff0000 text-decoration: underline; }",
               "keepElement":      true,
               "keepAttribute":    true
            },
            {
         ...
         "children": [
            {
               ...
               "text":             "Language",
               "issue":            "The language of the page is not set. Developers should define the natural language of a document to ensure that screen readers and other user agents understand the language the document is to be interpreted in.",
               "impact":           "Specifically, when a document contains multiple inline language choices, screen readers and other assistive technology types must know what the default language type is to ensure they can appropriately switch between languages. Per the HTML 4.01 recommendation, language declarations should be made in accordance with IETF RFC 1766.",
               "example":          "<!doctype html>\n<html>\n<head>",
               "recommendation":   "Ensure that the lang attribute is set within the HTML element. Always use a language attribute on the HTML element. This is inherited by all other elements, and so will set a default language for the text in the document head element.\n\nIf you have any content on the page that is in a different language from that declared in the HTML element, use language attributes on elements surrounding that content. This allows you to style or process it differently.",
            ...
            },
            {
               ...
               "impact":           "Users, especially those with limited vision or using mobile devices, need to be able to increase the size of the textual elements on the pages. By disabling this with the viewport, users will not be able to zoom in.",
               "recommendation":   "Remove the maximum scale and user-scalable attributes from the viewport META element.",
               "compliantExample": "<meta content='width=device-width; initial-scale=1.0;' name='viewport' />",
               "keepElement":      true
            },
            {
               "id":               "response-skipnav",
               ...
               "impact":           "Repetitive content found on a set of pages requires a method to allow a user to skip past it, so the user can get to the page's main/unique content as efficiently as possible. For example, consider a user who is blind using a screen reader or a keyboard-only user. Each time the user accesses a new page in a site with a top navigation bar, the user would be forced to navigate past e.g. tab through all of these navigation links (and other content) before getting to the main content area of the page. This makes it difficult to access the page's main/unique information efficiently.",
               "recommendation":   "Provide a valid skip link that directs users to the unique content of each page. This can be hidden, but needs to become visual when focused upon.",
               "compliantExample": "<style>\n\n   #skip a { position:absolute; left:-10000px; top:auto; width:1px; height:1px; overflow:hidden; }\n\n   #skip a:focus { position:static; width:auto; height:auto; }\n\n</style>\n\n<div id=\"skip\">\n   <a href=\"#main\">Skip to Main Content</a>\n</div>"
            },
            {
               "id":             "response-pagetitle",
               "text":           "Title",
               "impact":         "The title of a page must provide information specific to the currently viewed page. Assistive technologies utilize the page title to indicate the current page location to users without the user having to navigate within the page. Because assistive technology often reads the page title first, this content should inform the user of the content to be found (topic) or action to be performed on (purpose of) that page.",
               "recommendation": "Ensure that the value for the title element is updated as the page content changes. The title element should be terse yet informative and contain information which discloses the content to be found or action to be performed on that page and should avoid containing extra information that does not aid in this understanding. The title of the page should be in the primary language of the page.",
               "keepElement":    true,
               "keepAttribute":  true
            }
         ]
         ...
         "children": [
            {
               ...
               "text":           "Row TH",
               "impact":          "Table row cells that act as header cells for a row of data need to communicate this programmatically. Row header cells are often identified visually by boldface or other differences in color/font compared to data cells (though this is less common than for column header cells). When table row headers do not communicate their status as headers, assistive technology such as screen readers may not announce the correct row header cells when users navigate up/down columns of data.",
               "recommendation": "Make sure th elements are used for cells that represent row headers. In addition, add the scope attribute with a value of row. This requirement is particularly critical if the row header cells are not in the first column.",
               "keepElement":    true,
               "keepAttribute":  true
            }
         ]
...
function dataCSS() {
   var cssArray = {
      ...
      "#view_violations_container .wrap": "text-overflow: ellipsis; overflow: visible !important; white-space: pre-wrap !important;",
      ...
      "table tbody tr:nth-child(even) th:not(.table-cell-header)": "background: #D6DAF7;",

      // View All Instances Description column styling reset
      "table#instances": "border-collapse: collapse",
      "table#instances th[scope='row']": "font-weight: normal; border: 1px solid #ddd !important; background: inherit;",
      ...
      "#kpmNav li": "font-weight:bold; color:#000; background:#d7d7d7; display:block; float:left; padding:0.2rem 0.5rem; position:relative; text-decoration:none; transition-duration:0.5s; border:1px solid #000; border-right:none; text-align:center;",
      ...
      "#kpmNav ul li ul": "background:#3359ec; visibility:hidden; opacity:0; position:absolute; transition:all 0.5s ease; margin-top:0.1rem; left:0; display:none;",
      ...
      "#kpmNav ul li ul li": "border:1px solid #000; border-bottom: none; line-height:1em; clear:both; width:100%; padding:0.3em; margin:0; text-align:left; font-weight:normal;",
      ...
      "#kpmAllResponsesPage h2": "margin: 2em 0 0 0; border-bottom: 1px solid #000;",
      "#kpmAllResponsesPage h3": "margin: 0.5em 0 0 0;",

      /* Fix visually hidden blank lines that appear when copy-pasting near
         checkboxes */
         "table td:not(.actions)": "white-space: unset !important; word-wrap: unset !important"
...
function preferencesBox() {
   ...
   var customOptions = dataCustom();

   var selectCustom = "<h3>Custom Formatting</h3><ul><li><a href='#' id='kpmCustom-default'>Default</a></li>";
   var i;
   for (i = 0; i < customOptions.length; i++) {
      var currentID = "kpmCustom-" + customOptions[i].id;
      var cbCookie = getCookieValue(currentID);
      selectCustom += "<li><a href='#' id='kpmCustom-" + customOptions[i].id + "'>" + customOptions[i].name;
      if (cbCookie) { selectCustom += " [Custom Selected]"; }
      selectCustom += "</a></li>";
   }
   selectCustom += "</ul><p>Post in <a href=\'https://level-access.slack.com/messages/CK79W4PPU/\'>the Level Access #as-access-companion Slack channel</a> if you have any other custom formatting needs.</p><br /><p><strong>New</strong>: <a href=\"#\" id=\"kpmViewAll\">View all preferred responses.</a></p>";
   ...
   prefTD1.appendChild(buildCheckbox(
      'moveInstanceLink',
   ...
   prefTD3.appendChild(buildCheckbox("nonBookmarkedOrgs","Default to non-bookmarked Orgs","Don't check the 'Bookmarks only' checkbox in the 'Change Organization' modal"));
   prefTD3.appendChild(buildCheckbox("hideFixModuleInfo","Don't show AMP Script buttons in Edit Module modal","Don't show the 'Fix Name' and 'Fix Alt Text' buttons in the 'Edit Module' modal"));
   prefTD3.appendChild(document.createElement("h3")).appendChild(document.createTextNode("Script Elements"));
   prefTD3.appendChild(buildCheckbox("hidePrefs","Hide AMP script preferences","Hides the ACE AMP Script preferences box"));
...
function viewAltText() {
   $("td img").each(function () {
      ...
      var imgTxt = document.createTextNode("ALT: " + escapeHtml(altText));
...
function testModuleLinks(moduleID) {
   ...
   editLink += '<li><a href="#" onclick="window.location.search=window.location.search+\'&mark_complete=true\'; instHandler.showModule(); return false;">Mark Complete<span class="accessibleAltText">Opens separate pane</span></a></li>';
   return editLink;
}
...
function retestColor() {
   $("td:has(pre) pre").add("td:has(span) span").each(function () {
      ...
      if (
         thisTD.text().split("]")[0].indexOf("UNDER REVIEW") >= 0
      ) {
         var number0 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("MOBILE ONLY") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("WEB ONLY") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("MISSING OR UNIDENTIFIED VIOLATION") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("ISSUE MISALIGNMENT") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("NOT AN ISSUE, REMOVAL REQUIRED") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("RECOMMENDATION DOES NOT MAKE SENSE") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("SILLY MISTAKE") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("TYPO OR GRAMMAR ISSUE") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("USE CASE RESULT ISSUE MISSING") >= 0
      ) {
         var number00 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
      ...
      if (
         thisTD.text().split("]")[0].indexOf("UPDATED") >= 0
      ) {
         var number2 = thisTD.closest("tr").children("td").length;
         thisTD.closest("tr").before(
...
function createListResponse(array, name, id) {
   var output = '<li><a href="#" aria-haspopup="true">' + name + ' <span class="fas fa-angle-down"></span></a><ul class="dropdown">';
   var i = 0;
...
function addSuccessCriteria(){
  var customSCOptions = dataSuccessCriteria();
  var sc_option = "";
  var i=0;
  ...
  var sc_select = "<div class='kpmP flex-center'><label class='right-margin' for='" + customSCOptions[0].id + "'>" + customSCOptions[0].text +"</label><select id='" + customSCOptions[0].id + "'>" + sc_option + "</select></div>";
  // add update button
  sc_select += "<input type='button' id='update-sc' value='Update' class='kpmFirstButton' aria-label='Update Success Criterion'>";
  return sc_select;
}
...
function createAddInstanceButtons(preferred,response,status,reading,code,reviews) {

   var currentID = $("[id*='violation_']").children("option:selected").attr("value");
   var customFormat = dataCustom();
   var createButtons = "";
   createButtons += "<br>";
   createButtons += "<input type='button' id='ChgBPNow' value='Change Best Practice' class='kpmFirstButton'>&nbsp;";

   createButtons += "<input type='button' id='GoToBP' value='Open BP (New Window)' class='kpmFirstButton'>&nbsp;";
   createButtons += "<input type='button' id='addLangBlank' value='Blank Response' class='kpmFirstButton'>&nbsp;";
   createButtons += "<input type='button' id='clearFields' value='Clear Fields' class='kpmFirstButton'><br>";
   ...
   createButtons += "<li><a href=\"#\" id=\"kpmPrefSearch\"><span class=\"fas fa-search\"></span></a>";
...
function formatElement(issue, impact, codeReference) {
   ...
   if (getCookieValue("kpmCustom-custom-wf")) {
      ...
      if (issue && issue.length > 0 || impact && impact.length > 0) {
         if (issue && issue.length > 0) { output += issue.trim();}
         if (issue && issue.length > 0 && impact && impact.length > 0) { output += "\n\n"; }
         if (impact && impact.length > 0) { output += impact.trim(); }
      }
      else {
         output += "**Describe the problem or symptom, the User Impact, and sufficient info about how to reproduce.**"
      }
      output += "\n\n[Devices]\n****";
   ...
   else if (getCookieValue("kpmCustom-custom-progressive-apq") || getCookieValue("kpmCustom-custom-progressive-dq-inc-mobile")) {
     output += "[Issue]\n";
     if (issue && issue.length > 0) {
       output += "** When using AMPScript template text, be sure to make the issue description specific, and include ALL instances that you observe on the page **\n\n";
       output += issue.trim().replaceAll('Examples include:', 'Specific instances are:');
     }
    ...
    output += "\n\n[Code Reference]\n";
    if (codeReference && codeReference.length > 0) { output += codeReference.trim(); }
   }
   ...
   if (getCookieValue("kpmCustom-custom-wf")) {
      ...
      if ($("#1_page").length <= 0) {
         ...
         if (codeExample && codeExample.length > 0) {
            ...
            output += "**Optional or type \"None\". Avoid lengthy blocks. Newlines and indentation spaces will be stripped.**";
         }
         output += "\n\n[Recommended Reading]\n";
      ...
      output += "[EXPECTED BEHAVIOR - Description is required. Compliant code is optional.]\n";
      if (recommendation && recommendation.length > 0) {
         output += recommendation.trim();
      }
...
function listAllResponses(array) {
   var output = "<div id=\"kpmAllResponsesPage\"><h1>All Responses</h1>";
   ...
   for (i=0; i < array.length; i++) {
      ...
      var tempElement = escapeHtml(formatElement(array[i].issue,array[i].impact,array[i].codeReference));
      var tempAttribute = escapeHtml(formatAttribute(array[i].recommendation,array[i].reading,array[i].compliantExample));

      output += "<h2>" + array[i].text + ": ";
      var j;
      var bpsLength = array[i].bps.length;
      for (j=0; j < bpsLength; j++) {
         output += array[i].bps[j];
         if (j + 1 != bpsLength)
         { output += ", " }
      }
      output += "<span style=\"float: right;\">[ <a href=\"#\" onclick=\"window.location.reload();\">Close</a> ]</span></h2>";
...
function convertColorContrastTextFromAE(noteTextFromAE) {
   ...
   var bgColorRE = /background color of (#[0-9a-fA-F]+)/;
   var fgColorRE = /foreground color of (#[0-9a-fA-F]+)/;
   var contrastRatioRE = /contrast ratio of ([0-9\.]+)/;
   var requiredRatioRE = /[0-9\.]+:1/;
   var colorContrastTextAll = "";

   if (noteTextFromAE && typeof noteTextFromAE === "string") {
      var colorContrastTextFg = noteTextFromAE.match(fgColorRE);
      var colorContrastTextBg = noteTextFromAE.match(bgColorRE);
      var colorContrastTextContrastRatio = noteTextFromAE.match(contrastRatioRE);
      var colorContrastTextRequiredRatio = noteTextFromAE.match(requiredRatioRE);

      if (colorContrastTextFg && colorContrastTextBg && colorContrastTextContrastRatio && colorContrastTextRequiredRatio) {
        colorContrastTextAll = "\n\n" +
                               "Foreground color: " + colorContrastTextFg[1] +
                               "\n" +
                               "Background color: " + colorContrastTextBg[1] +
                               "\n" +
                               "Contrast ratio: " + colorContrastTextContrastRatio[1] + ":1" +
                               "\n" +
                               "Required contrast ratio for this content: " + colorContrastTextRequiredRatio[0];
      }
   }
...
function handleOrganizationFilterForm(reportID) {
   if ($("#organization-filter-form").length !== 0 && !$("#org-bookmarks-only").prop('checked') ) {
...
function handleTestingCompleteCheckbox(reportID) {
  if ($("#testing_complete").length !== 0 && !$("#testing_complete").prop('checked') ) {
...
// TOOL: Convert escaped HTML entities back to their original
// (From https://stackoverflow.com/questions/5796718/html-entity-decode)
// Modified to preserve any actual HTML elements.
var decodeEntities = (function() {
  // this prevents any overhead from creating the object each time
  var element = document.createElement('div');

  function retainHtmlElements(match, p1, p2, p3, offset, string) {
  ...
  function decodeHTMLEntities (str) {
    if(str && typeof str === 'string') {
      ...
      str = str.replace(/<\/?\w(?:[^"'>]|"[^"]*"|'[^']*')*>/gmi, retainHtmlElements);
...
// TOOL: Strip off any module number at the start of a string,
// e.g.
//  "1. Module name"
//  "02. Module name"
//  "123. Module name"
...
//  "10.a Module name"
//  "20.2.a Module name"
// all become "Module name"
//
function removeModuleNumber(thumbnailAlt) {
   if (thumbnailAlt) {
      thumbnailAlt = thumbnailAlt.replace(/^(\d+\.?)+(\w\.?)?\s+/, "");
   }
   return thumbnailAlt;
}

// Add buttons to the Edit Module Form to fix any escaped HTML entities in the module name and thumbnail alt text.
function handleEditModuleForm(reportID) {
  if (getCookieValue("kpmPref-hideFixModuleInfo")) {
    if ($("#fixModuleName").length === 0 && window.location.href.indexOf("view_use_cases.php") <= -1) {
      var name = $("#name").val();
      if(name !== decodeEntities(name)) {
        $("#name").after("<button type='button' id='fixModuleName'>Fix Name</button>");

        $("#fixModuleName").on("click", function () {
          var name = $("#name").val();
          $("#name").val(decodeEntities(name));
        });
      }
    }
    if ($("#fixThumbnailAlt").length === 0 && window.location.href.indexOf("view_use_cases.php") <= -1) {
      var thumbnailAlt = $(".modalContent textarea[id|=alt]").text();
      if(thumbnailAlt !== removeModuleNumber(decodeEntities(thumbnailAlt))) {
        $(".modalContent textarea[id|=alt]").after("<button type='button' id='fixThumbnailAlt'>Fix Alt Text</button>");

        $("#fixThumbnailAlt").on("click", function () {
          var thumbnailAlt = $(".modalContent textarea[id|=alt]").text();
          $(".modalContent textarea[id|=alt]").text(removeModuleNumber(decodeEntities(thumbnailAlt)));
        });
      }
    }
  }
...
function addEditor(reportID) {
   if ($("#amp_modal_reportModal").length !== 0 && $("#AmpOpts").length === 0 && window.location.href.indexOf("view_use_cases.php") <= -1) {
      ...
      // Place the buttons
      $("#AmpOpts").after(createAddInstanceButtons(dataPreferredFiltered(currentID),dataResponse2(),dataStatus(),dataReading(),dataCode(),dataReviews()));

      // Changes the best practice
      $("#ChgBPNow").on("click", function () {
         var inputValue = $("#ampOptsInpt").val().trim();
         var newBP = parseInt($("#AmpOpts option[value=\"" + inputValue + "\"]").attr("data-value"));
         // console.log(inputValue + " * " + newBP);
         $("select[id*='violation_']:first").val(newBP);
         var BPValue = 0;
         $("select[id*='severity_']:first").val(BPValue).val();

         var newPreferredListList = dataPreferredFiltered(newBP);
         if (newPreferredListList.length > 0) {
            $("#kpmPreferred").replaceWith(createList2(newPreferredListList, "Preferred","kpmPreferred"));
         }
      });
      ...
      $("body").delegate("[id*='response-']","click",function () {
         ...
         if (newVar2) {
            var oldVar2 = $("textarea[id*='attribute']:first").add("textarea[id*='note']:first").val();
            $("textarea[id*='attribute']:first").add("textarea[id*='note']:first").val(newVar2 + oldVar2);
         }
      });
      ...
      $("[id*='reviews-']").click(function () {
         ...
         var text1 = "";
         var str1 = $("textarea[id*='element']:first").val();
         var index1 = str1.indexOf("Fixed]");
         var index2 = str1.indexOf("Not Fixed]");
         var index3 = str1.indexOf("[Type");
         var index4 = str1.indexOf("[WCAG");
         var index5 = str1.indexOf("Partially Fixed]");
         var index6 = str1.indexOf("[Pattern");
         var index7 = str1.indexOf("[Issue]");
         var thisIndex1 = 0;
...
(function () {
   ...
   // Testing Mode - Normal view for Level Access Testers
      ...
      if ( reportID !== null && $("#content") && !getCookieValue("kpmPref-hidePrefs")) {
         ...
         $("#content").append(
            buildCheckbox("hidePrefs","Show AMP Script Preferences","Shows The ACE AMP Script preferences box")
         );
      }

      $("#kpmViewAll").on("click", function () {
      ...
      if (!getCookieValue("kpmPref-globals")) {
         ...
         if (window.location.href.indexOf("/view_globals_and_patterns.php") >= 0) {
            ...
            $("#view_globals_container").after('<p class="kpmSmall">Globals hidden by the ACE AMP Script. You can make them show again in the preferences below.</p>');
         }
      ...
      if ($("#amp_modal_reportModal").length === 0) {
         ...
         var addObserver = new MutationObserver(function (mutations, me) {
            ...
            var changeOrganization = document.getElementById('organization-filter-form');
            if (changeOrganization) {
              handleOrganizationFilterForm(reportID);
              me.disconnect(); // stop observing
              return;
            }
            var testingCompleteCheckbox = document.getElementById('testing_complete');
